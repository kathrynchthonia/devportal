        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              <h1 className="display-4 text-cent">Edit Your Profile</h1>
              <p className="lead text-cente">What's new?</p>
              <small className="d-block pd-">* = required fields</small>
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="If you want to include your latest repos and a Github link, include your Username"
                />
                <TextAreaFieldGroup
